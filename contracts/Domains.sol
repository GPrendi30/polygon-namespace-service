...
contract Domains is ERC721URIStorage {
    ...
    function price(string calldata name) public pure returns (uint256) {
        uint256 len = StringUtils.strlen(name); // find the length of the string
    ...
    function register(string calldata name) public payable {
        require(domains[name] == address(0)); // only one has acquired the name
        ...
        // minting the token, saving the domain nome and safely incrementing the counter
